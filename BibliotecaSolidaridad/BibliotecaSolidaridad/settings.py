"""
Django settings for BibliotecaSolidaridad project.
...
SECRET_KEY = 'django-insecure-c((-a&5xc**6sg(c-#-9-qh#7qtzb0--6h&f=hmne=dgbzf8ub'
...
# Cache (para Dashboard y búsquedas)
CACHES = {
    'default': {
